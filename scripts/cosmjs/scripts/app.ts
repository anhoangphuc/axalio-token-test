...
const main = (async function () {
    ...
    const queryClient = new QueryClient(tendermintClient as any);
    ...
    console.log("recipient mnemonic:", recipientWallet.mnemonic);
...
export async function getGasPriceWithMultiplier(feemodelQueryClient: FeemodelQueryClient) {
    ...
    console.log("------------------------------------")
    console.log(minGasPriceRes)
    console.log(`min gas price: ${minGasPrice.toString()}`)
    console.log(`min gas price: ${minGasPrice.toFloatApproximation()}`)
